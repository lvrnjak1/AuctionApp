...
function About() {
    return (
        <div id="about-page">
            ...
            <div id="images">
                <img src={process.env.PUBLIC_URL + '/images/img1.jpg'} alt="first" id="image-large" />
                <img src={process.env.PUBLIC_URL + '/images/img2.jpg'} alt="second" class="image-small" />
                <img src={process.env.PUBLIC_URL + '/images/img3.jpg'} alt="third" class="image-small" />
            </div>
        </div >
